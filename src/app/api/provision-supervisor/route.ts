...
export async function POST(req: Request) {
  ...
  const { email, password, full_name, staff_id, academic_title, is_external, faculty_id, department_id, workplace } = body;
  if (!email || !password || !full_name || !staff_id || !academic_title) {
